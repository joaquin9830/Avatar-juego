...
// Función para detener la música actual y reproducir una nueva
function detenerMusicaYReproducir(tipo) {
    ...
    if (audioJuego) {
        ...
        audioJuego.currentTime = 0;  // Reinicia la música del juego
    }

    if (tipo === 'victoria' && audioVictoria) {
        audioVictoria.currentTime = 0;  // Reinicia la música de victoria
        audioVictoria.play();  // Reproduce la música de victoria
    } else if (tipo === 'derrota' && audioDerrota) {
        audioDerrota.currentTime = 0;  // Reinicia la música de derrota
